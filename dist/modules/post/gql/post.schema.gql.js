...
const PostGQLArgs = __importStar(require("./post.args.gql.js"));
const post_resolver_js_1 = require("./post.resolver.js");
class PostGQLSchema {
    postResolver;
    constructor() {
        this.postResolver = post_resolver_js_1.postResolver;
    }
    registerQuery() {
        return {
            postList: {
