...
router.post('/signup', (0, validation_middleware_js_1.validation)(validators.signup), async (req, res, next) => {
    const data = await auth_service_1.default.signup(req.body);
    return (0, success_response_js_1.successResponse)({ res, data });
});
router.patch('/confirm-email', (0, validation_middleware_js_1.validation)(validators.confirmEmail), async (req, res, next) => {
    await auth_service_1.default.confirmEmail(req.body);
    return (0, success_response_js_1.successResponse)({ res });
});
router.patch('/resend-confirm-email', (0, validation_middleware_js_1.validation)(validators.resendConfirmEmail), async (req, res, next) => {
    await auth_service_1.default.confirmEmail(req.body);
    return (0, success_response_js_1.successResponse)({ res });
});
router.post('/login', (0, validation_middleware_js_1.validation)(validators.login), async (req, res, next) => {
